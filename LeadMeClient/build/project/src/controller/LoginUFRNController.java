...
import static consumidor_api.ConsumidorAPISinfo.URL_AUTENTICACAO_SINFO;
import static consumidor_api.ConsumidorAPISinfo.URL_ENCAMINHA;
...
public class LoginUFRNController {
    ...
    private boolean carregouMatriculas = false;
        ...
        engine.setOnStatusChanged(new EventHandler<WebEvent<String>>() {
            public void handle(WebEvent<String> event) {
                if (event.getSource() instanceof WebEngine) {
                    ...
                    if (location.startsWith(URL_ENCAMINHA) && location.contains("code") && !carregouMatriculas) {
                        try {
                            consumidor.carregarAccessToken(location);
                            carregarAlunoParaService();
                            carregouMatriculas = true;
                            util.carregarTela("TelaPrincipal.fxml", "Lead Me");
