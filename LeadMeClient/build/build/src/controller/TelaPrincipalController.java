...
//        carregarDisciplinasMaisDificeis(alunoLogado.getCurso());
    ...
    private void carregarGraficoAprovacoes() {
        ...
        carregarListaTurmasSelecionavel(disciplinaSelecionadaEstatistica);
        txtDisciplina.clear();
    }

    private void carregarListaTurmasSelecionavel(Disciplina disciplina) {
        List<Turma> turmasSelecionaveis = disciplinaService.carregarTurmasDaDisciplina(disciplina);
    ...
    private void carregarMatrizesDoCurso(Curso curso){
        ObservableList<MatrizCurricular> listaObs = FXCollections.observableArrayList(cursoService.carregarMatrizesCurricularesDoCurso(curso));
