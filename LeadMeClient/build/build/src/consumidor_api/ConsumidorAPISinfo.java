 ...
 * @author rafao
 */
public class ConsumidorAPISinfo {
    ...
    private static ConsumidorAPISinfo instance = new ConsumidorAPISinfo();
    private String accessToken;
    private List<SituacaoMatriculaUfrnDTO> situacoesMatricula;

    private ConsumidorAPISinfo() {
        situacoesMatricula = null;
    }

    public static ConsumidorAPISinfo getInstance() {
        return instance;
    }
    ...
    public String carregarAccessToken(String location) throws JSONException, IOException {
        ...
        if (codigo != null) {
            ...
            try {
                ...
                Logger.getLogger(ConsumidorAPISinfo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        return null;
    }
